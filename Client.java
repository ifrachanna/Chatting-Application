...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon img4 = new ImageIcon(ClassLoader.getSystemResource("icons/eni.png"));
        ...
        textClient.setBounds(5, 655, 310, 40);
        textClient.setFont(new Font("SAN_SERIF", Font.PLAIN, 16));
        mainframe.add(textClient);
